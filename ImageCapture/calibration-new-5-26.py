...
def undistort(h, w, matrix, distortion, imageTitle):
    ...
    original_image = cv2.imread(imageTitle)

    # Perform image distortion and save it as a new image
    ...
    # Save the new image with the original metadata
    new_photo = Image.open(newPathway)
    new_photo.save(newPathway, **original_metadata)
